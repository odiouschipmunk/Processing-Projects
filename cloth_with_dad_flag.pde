...
void setup() {
  ...
  image = loadImage("https://lh3.googleusercontent.com/-kJ-EqA1SB0o/YHiVEDx3AOI/AAAAAAAACvg/mLD8-i8Rj2Y-roqvigpEO8OnGOuSWvgvgCK8BGAsYHg/s0/2021-04-15.png?authuser=0");
}
void draw() {
  background(51);
